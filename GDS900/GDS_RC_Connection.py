...
#GDS_Connect() #Made into a function b/c no connection at this time. Uncomment when redy to implement
...
def AssignNextToAnalyze():
    ...
    print("ANTA Error Message:", LRAS_error_message)
    #Gets the ("Set") Element and attribute 
