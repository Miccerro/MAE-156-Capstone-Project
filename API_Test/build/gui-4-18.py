...
#import the impor library 
import sys
sys.path.append(r'C:\Users\emont\OneDrive\Desktop\MAE156A') #The parent folder that contains source code to be called/imported

OUTPUT_PATH = Path(__file__).parent
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\emont\OneDrive\Desktop\MAE156A\MAE-156-Capstone-Project\Python GUI Tests 2\build\assets\frame0")
...
def toggle_buttons_4_6(button):
    if button.image_state == "dark":
        if button == button_4:
            # Set the state to calibration_on when pressed
            ...
            # Set the state to calibration_off when pressed
...
button_4.config(command=lambda: print(toggle_buttons_4_6(button_4)))
...
button_6.config(command=lambda: print(toggle_buttons_4_6(button_6)))

#calibration_mode = toggle_buttons_4_6(button_4)
